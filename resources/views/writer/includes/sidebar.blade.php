    ...
    <ul class="sidebar-menu">
      ...
      <li>
        <a href="{{route('writer.home')}}">
          <i class="@yield('home') fa fa-home"></i>
          <span>Home</span>
        </a>
      </li>
      <li class="@yield('stateall')">
        <a href="{{route('writer.all')}}">
      ...
      <li  class="@yield('statecom')">
        <a href="{{route('writer.complete')}}">
      ...
      <li  class="@yield('statepen')">
        <a href="{{route('writer.pending')}}">
          <i class="fa fa-circle-o text-blue"></i>
          Pending Orders
          <span class="pull-right-container">
            <small class="label pull-right bg-blue">{{count($jobspending)}}</small>
          </span>
        </a>
      </li>
      <li  class="@yield('staterev')">
        <a href="{{route('writer.revision')}}">
      ...
      <li  class="@yield('staterej')">
        <a href="{{route('writer.rejected')}}">
