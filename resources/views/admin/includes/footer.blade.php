...
<script src="{{asset('userfin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
...
<script src="{{asset('userfin/bower_components/Flot/jquery.flot.js')}}"></script>
<script src="{{asset('userfin/bower_components/Flot/jquery.flot.resize.js')}}"></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src="{{asset('userfin/bower_components/Flot/jquery.flot.pie.js')}}"></script>
<!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
<script src="{{asset('userfin/bower_components/Flot/jquery.flot.categories.js')}}"></script>
...
<script>
  $(function () {
    ...
    var bar_data = {
      data : [
        ['Jan', 10], ['Feb', 8], ['Mar', 4], ['Apr', 13],
        ['May', 17], ['Jun', 9],['Jul',12],['Aug',0],
         ['Sep',2],  ['Oct',4],['Nov',7],['Dec',1]
      ],
      color: '#3c8dbc'
    }
    ...
    var donutData = [
      { label: 'Admins', data: 40, color: 'orange' },
      { label: 'Clients', data: 300, color: 'green' },
      { label: 'Writers', data: 125, color: 'blue' },
      { label: 'SAdmins', data: 5, color: 'red' }
    ]
