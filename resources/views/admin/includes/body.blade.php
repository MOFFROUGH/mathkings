  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div style="text-align:center">
        <a href="{{route('admin.home')}}" class="btn btn-warning">Main Dashboard</a>
        <a href="{{route('admin.home2')}}" class="btn btn-warning">Orders and Writers</a>
        <a href="{{route('admin.home3')}}" class="btn btn-warning">Clients and Admin</a>
        <a href="{{route('admin.home4')}}" class="btn btn-warning">Graphs</a>
